  ...
  return [
    {
      ...
      patientRef: anonymizedRef('VL-2026-100001'),
      ageGroup: '15-44',
      gender: 'female',
      reportedAt: day(0),
      source: 'lab_positive',
    ...
    },
    {
      ...
      patientRef: anonymizedRef('VL-2026-100002'),
      ageGroup: '45-64',
      gender: 'male',
      reportedAt: day(1),
    ...
    },
    {
      ...
      patientRef: anonymizedRef('VL-2026-100003'),
      ageGroup: '5-14',
      gender: 'male',
      reportedAt: day(2),
      source: 'community',
    ...
    () => ({
      ...
      createCase: async (data: NewCaseData) => {
        ...
        const newCase: SentinelCase = {
          ...
          patientRef: data.patientRef || anonymizedRef(`VL-${Date.now()}`),
